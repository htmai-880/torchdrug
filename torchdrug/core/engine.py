...
class Engine(core.Configurable):
    ...
    def __init__(self, task, train_set, valid_set, test_set, optimizer, scheduler=None, gpus=None, batch_size=1,
                 gradient_interval=1, num_worker=0, logger="logging", log_interval=100, eval_batch_size=None):
        ...
        self.eval_batch_size = eval_batch_size if eval_batch_size is not None else min(batch_size, 200)
